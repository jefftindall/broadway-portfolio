...
| `DISC-P3-006` | Monthly Search Console query review → new/refined `/for/*` | `planned` | Monthly | Search Console, casting content; joint GSC+GA checklist in [search-ops-monthly.md](../runbooks/search-ops-monthly.md) (`SEARCH-P3-001` / `SEARCH-P3-002`) |
