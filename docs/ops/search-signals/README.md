...
Scheduled: `.github/workflows/search-ops-monthly.yml` (1st of month, 13:00 UTC — before ops scorecard). Also runs `DISC-P4-007` casting-language discover. CD ignores commits under this directory and `docs/ops/casting-language/`.
